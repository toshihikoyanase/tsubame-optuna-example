...
# ==============================================================================
# from https://raw.githubusercontent.com/horovod/horovod/v0.13.11/examples/tensorflow_mnist.py
#!/usr/bin/env python
...
def objective(trial, comm):
    ...
    checkpoint_dir = './checkpoints-{}'.format(trial_number) if hvd.rank() == 0 else None
    ...
    with tf.train.MonitoredTrainingSession(checkpoint_dir=checkpoint_dir,
        ...
        loss_value = loss.eval(feed_dict={image: mnist.test.images, label: mnist.test.labels},
                               session=mon_sess)
